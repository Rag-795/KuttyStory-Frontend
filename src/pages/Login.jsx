        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
                    ...
                    <h2 className="text-3xl font-bold mb-4 text-center">Welcome to Kutty Story</h2>
                    <p className="text-white/70 text-center max-w-md">
                        Create stunning AI-powered videos from simple text prompts.
            ...
            <div className="flex-1 flex items-center justify-center p-8 bg-background">
                ...
                >
                    ...
                    <p className="text-muted mb-8">Welcome back! Please enter your details.</p>
